...
export const PROBABILITY_TABLE = {
  '大房子': {
    '荒村': [15, 3, 5, 7, 8, 13, 19, 26, 2, 2],
    '遗迹': [13, 10, 5, 8, 7, 12, 18, 20, 4, 3],
    '城市': [12, 8, 4, 5, 12, 11, 19, 20, 5, 4]
  },
  '小房子': {
    '荒村': [3, 11, 16, 19, 18, 15, 11, 6, 1, 0],
    '遗迹': [3, 11, 15, 18, 18, 15, 11, 6, 2, 1],
    '城市': [3, 11, 15, 17, 17, 15, 11, 6, 3, 2]
  },
  '山洞': {
    '荒村': [20, 18, 16, 13, 11, 9, 7, 5, 1, 0],
    '遗迹': [19, 17, 16, 13, 11, 9, 7, 5, 2, 1],
    '城市': [18, 16, 15, 13, 11, 9, 7, 5, 4, 2]
  },
  '草坪': {
    '荒村': [27, 22, 17, 13, 9, 6, 4, 2, 0, 0],
    '遗迹': [27, 21, 17, 13, 9, 6, 4, 2, 1, 0],
    '城市': [26, 21, 17, 13, 9, 6, 4, 2, 1, 1]
  }
} as const;
